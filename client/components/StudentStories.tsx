...
export default function StudentStories() {
  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      ...
      const newMaxIndex = Math.max(0, studentsData.students.length - newItemsPerView);
    ...
    if (isMobile && studentsData.students.length > 1) {
      const interval = setInterval(() => {
        setCurrentIndex((prevIndex) => {
          const newMaxIndex = Math.max(0, studentsData.students.length - itemsPerView);
  ...
  return (
    <section ref={sectionRef} className="py-16 md:py-20 bg-gradient-to-br from-blue-50 to-purple-50 relative overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          {/* Stories Grid */}
          <div className={`stories-grid grid gap-6 md:gap-8 ${
            ...
            {visibleStudents.map((student, index) => (
              ...
              >
                ...
                <div className={`relative ${
                  ...
                  <Quote className={`text-orange-400 mb-2 opacity-50 ${
                ...
                <div className="text-center">
                  <div className={`inline-flex items-center space-x-2 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-full font-bold shadow-lg ${
