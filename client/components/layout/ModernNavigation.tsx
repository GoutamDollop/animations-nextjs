...
export default function ModernNavigation() {
  ...
  const toggleMobileDropdown = (itemName: string) => {
    setIsMobileDropdownOpen(prev => prev === itemName ? null : itemName);
  };
              ...
              >
                ...
                <AnimatePresence>
                  {item.hasDropdown && activeDropdown === item.name && (
                    <motion.div
                      className="absolute top-full left-0 mt-2 w-64 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-purple-100/50 overflow-hidden z-50"
