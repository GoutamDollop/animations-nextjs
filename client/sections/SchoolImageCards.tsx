...
const schoolCards: SchoolCard[] = [
  {
    ...
    description: "Our campus features cutting-edge technology and modern architecture designed to inspire learning and creativity. Every classroom is equipped with interactive whiteboards, high-speed internet, and comfortable seating arrangements.",
    image: "https://images.unsplash.com/photo-1580582932707-520aed937b7b?ixlib=rb-4.0.3&auto=format&fit=crop&w=2832&q=80",
    icon: <BookOpen className="w-6 h-6" />,
    features: ["Smart Classrooms", "High-Speed WiFi", "Interactive Technology", "Climate Control"],
    stats: [
  ...
  },
  {
    ...
    description: "Our fully equipped science laboratories provide students with hands-on experience in physics, chemistry, and biology. Safety-first approach with modern equipment ensures optimal learning conditions.",
  ...
  },
  {
    ...
    description: "Our arts center encourages creativity through music, visual arts, drama, and dance. Professional-grade equipment and experienced instructors help students explore their artistic potential.",
  ...
  },
  {
    ...
    description: "Our comprehensive sports facilities include indoor and outdoor courts, swimming pool, and fitness center. We promote physical fitness and team spirit through various sports programs.",
    image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80",
    icon: <Dumbbell className="w-6 h-6" />,
    features: ["Swimming Pool", "Basketball Court", "Football Field", "Fitness Center"],
    stats: [
  ...
  },
  {
    ...
    description: "Our modern library combines traditional books with digital resources, providing students access to thousands of books, journals, and online databases for comprehensive research.",
    image: "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?ixlib=rb-4.0.3&auto=format&fit=crop&w=2128&q=80",
    icon: <Globe className="w-6 h-6" />,
    features: ["50K+ Books", "Digital Databases", "Study Rooms", "Research Support"],
    stats: [
  ...
  },
  {
    ...
    description: "Our innovation hub features robotics labs, 3D printing facilities, and coding spaces where students can explore emerging technologies and develop 21st-century skills.",
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      cardsRef.current.forEach((card, index) => {
        ...
        // Features animation
        tl.to(card.querySelectorAll(".feature-item"), {
          y: 0,
          opacity: 1,
          duration: 0.6,
          stagger: 0.1,
        ...
        // Stats animation
        tl.to(card.querySelectorAll(".stat-item"), {
          scale: 1,
          opacity: 1,
          duration: 0.8,
          stagger: 0.1,
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="section-header text-center mb-20">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-sm rounded-full px-6 py-3 mb-6">
            ...
            <span className="text-blue-600 font-semibold">Explore Our Campus</span>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover our state-of-the-art facilities designed to provide the best 
            learning environment for students to excel in academics, arts, and sports.
          </p>
        </div>
              ...
              >
                ...
                <div className={`${!isEven ? "lg:col-start-2" : ""} relative group`}>
                  <div className="card-image relative aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
                    ...
                    {/* Overlay */}
                    <div className={`card-overlay absolute inset-0 bg-gradient-to-br ${card.gradient} opacity-40 transition-opacity duration-300`}></div>
                    
                    {/* Floating icon */}
                    <div className={`absolute top-6 left-6 w-16 h-16 bg-white/90 backdrop-blur-sm rounded-2xl flex items-center justify-center shadow-xl text-${card.color}-500`}>
                      {card.icon}
                    </div>
                    ...
                    <div className="absolute bottom-6 left-6 right-6">
                      <div className="grid grid-cols-2 gap-4">
                        {card.stats.map((stat, statIndex) => (
                          ...
                          >
                            <div className={`text-2xl font-bold text-${card.color}-600 mb-1`}>
                              {stat.value}
                            </div>
                ...
                {/* Content */}
                <div className={`card-content ${!isEven ? "lg:col-start-1 lg:row-start-1" : ""} space-y-8`}>
                  {/* Badge */}
                  <div className={`inline-flex items-center space-x-2 bg-gradient-to-r from-${card.color}-500/10 to-${card.color}-500/5 rounded-full px-4 py-2`}>
                    <Award className={`w-4 h-4 text-${card.color}-500`} />
                    <span className={`text-${card.color}-600 font-medium text-sm`}>
                      {card.subtitle}
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {card.features.map((feature, featureIndex) => (
                      ...
                      >
                        <div className={`w-2 h-2 bg-gradient-to-r ${card.gradient} rounded-full flex-shrink-0`}></div>
                  ...
                  <div className="flex items-center space-x-4 pt-4">
                    <button className={`group inline-flex items-center space-x-2 bg-gradient-to-r ${card.gradient} text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg`}>
