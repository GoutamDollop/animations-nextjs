        ...
        if (content.length > 1) {
          ...
          content.forEach((item: any, index: number) => {
            if (index === 0) {
              ...
              timeline
                .to(item, { opacity: 1, scale: 1, duration: 1 }, "-=0.5")
      ...
      gsap.utils.toArray(".typewriter").forEach((element: any) => {
        ...
        gsap.to(element, {
          ...
          onUpdate: function () {
            ...
            element.textContent =
              text.slice(0, currentLength) + (progress < 1 ? "|" : "");
          },
          scrollTrigger: {
            trigger: element,
            start: "top 80%",
          ...
          scrollTrigger: {
            ...
            onUpdate: (self) => {
              ...
              const stateIndex = Math.floor(
                progress * (morphStates.length - 1),
              );
              const nextIndex = Math.min(
                stateIndex + 1,
                morphStates.length - 1,
              );
...
export const applyScrollAnimations = (
  ...
  animations.forEach((animation) => {
    if (
      ScrollAnimationClasses[animation as keyof typeof ScrollAnimationClasses]
    ) {
      element.classList.add(
        ScrollAnimationClasses[
          animation as keyof typeof ScrollAnimationClasses
        ],
      );
    }
  });
