      ...
      const metaTags = [
        {
          name: "description",
          content:
            "Best educational institution with modern facilities and excellent teachers",
        },
        {
          name: "keywords",
          content: "school, education, learning, students, teachers, courses",
        },
        ...
        { property: "og:title", content: "Amazing School - Quality Education" },
        {
          ...
          content:
            "Transform your future with our innovative educational programs",
        },
