  ...
  const features = [
    {
      ...
      description:
        "Experience cutting-edge curriculum designed by industry experts",
      icon: BookOpen,
    ...
    <div ref={heroRef} className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 text-center z-10">
          ...
          >
            Discover excellence in education with our innovative programs,
            world-class faculty, and vibrant campus community.
          </p>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Experience education reimagined with cutting-edge technology,
              expert guidance, and endless opportunities for growth.
            </p>
          </div>
