  ...
  const events = [
    {
      ...
      description: 'Showcase of innovative student projects and scientific discoveries.',
      featured: true
    },
    {
      id: 2,
        ...
        <div className="container mx-auto px-4 lg:px-8 text-center relative z-10">
          <div className="events-header max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl lg:text-2xl leading-relaxed">
              Join us for exciting events, competitions, and activities that bring our community together and create lasting memories!
            </p>
          </div>
        </div>
      </section>
              ...
              >
                ...
                <div className="p-4 md:p-6">
                  <div className="flex items-center justify-between mb-3">
                    <span className={`text-xs md:text-sm font-semibold px-3 py-1 rounded-full ${getCategoryColor(event.category)}`}>
                      {event.category}
                    </span>
        ...
        <div className="container mx-auto px-4 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-blue-100 mb-6 md:mb-8 leading-relaxed">
              We love to hear from our community! Share your event ideas and help us create amazing experiences together.
            </p>
