...
export default function Courses() {
  ...
  const categories = ['All', 'STEM', 'Arts', 'Languages', 'Sports', 'Technology'];
  ...
  const courses = [
    {
      ...
      category: "STEM",
      description: "Comprehensive program covering calculus, statistics, and advanced mathematical concepts.",
      duration: "12 months",
      students: 45,
      rating: 4.9,
      price: "$1,200",
    ...
    },
    {
      ...
      category: "Technology",
      description: "Learn programming, algorithms, and artificial intelligence fundamentals.",
      duration: "18 months",
      students: 38,
      rating: 4.8,
      price: "$1,800",
    ...
    },
    {
      ...
      category: "Arts",
      description: "Express yourself through various forms of creative writing and literary analysis.",
      duration: "10 months",
      students: 28,
      rating: 4.7,
      price: "$900",
    ...
    },
    {
      ...
      category: "STEM",
      description: "Explore the fundamental laws of physics and their engineering applications.",
      duration: "15 months",
      students: 32,
      rating: 4.8,
      price: "$1,500",
    ...
    },
    {
      ...
      category: "Languages",
      description: "Comprehensive Spanish language program with cultural immersion activities.",
      duration: "8 months",
      students: 25,
      rating: 4.6,
      price: "$800",
